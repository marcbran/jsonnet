...
local elements = {
  ...
  h2(attrOrChildren=[], childrenOrNull=null): elem('h2', attrOrChildren, childrenOrNull),
  h3(attrOrChildren=[], childrenOrNull=null): elem('h3', attrOrChildren, childrenOrNull),
  h4(attrOrChildren=[], childrenOrNull=null): elem('h4', attrOrChildren, childrenOrNull),
  h5(attrOrChildren=[], childrenOrNull=null): elem('h5', attrOrChildren, childrenOrNull),
  h6(attrOrChildren=[], childrenOrNull=null): elem('h6', attrOrChildren, childrenOrNull),
