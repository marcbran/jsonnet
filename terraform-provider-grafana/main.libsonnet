...
local provider(rawConfiguration, configuration) = {
  ...
  resource: {
    ...
    apps_dashboard_dashboard_v1beta1(name, block): {
      local resource = blockType.resource('grafana_apps_dashboard_dashboard_v1beta1', name),
      _: resource._(block, {
      }),
    },
    ...
    cloud_provider_aws_resource_metadata_scrape_job(name, block): {
      local resource = blockType.resource('grafana_cloud_provider_aws_resource_metadata_scrape_job', name),
      _: resource._(block, {
        aws_account_resource_id: build.template(block.aws_account_resource_id),
        disabled_reason: build.template(std.get(block, 'disabled_reason', null)),
        enabled: build.template(std.get(block, 'enabled', null)),
    ...
    k6_installation(name, block): {
      local resource = blockType.resource('grafana_k6_installation', name),
      _: resource._(block, {
        cloud_access_policy_token: build.template(block.cloud_access_policy_token),
        grafana_sa_token: build.template(block.grafana_sa_token),
        grafana_user: build.template(block.grafana_user),
        id: build.template(std.get(block, 'id', null)),
        k6_access_token: build.template(std.get(block, 'k6_access_token', null)),
        k6_organization: build.template(std.get(block, 'k6_organization', null)),
        stack_id: build.template(block.stack_id),
      }),
      cloud_access_policy_token: resource.field(self._.blocks, 'cloud_access_policy_token'),
      grafana_sa_token: resource.field(self._.blocks, 'grafana_sa_token'),
      grafana_user: resource.field(self._.blocks, 'grafana_user'),
      id: resource.field(self._.blocks, 'id'),
      k6_access_token: resource.field(self._.blocks, 'k6_access_token'),
      k6_organization: resource.field(self._.blocks, 'k6_organization'),
      stack_id: resource.field(self._.blocks, 'stack_id'),
    },
    k6_load_test(name, block): {
      local resource = blockType.resource('grafana_k6_load_test', name),
      _: resource._(block, {
        baseline_test_run_id: build.template(std.get(block, 'baseline_test_run_id', null)),
      ...
      baseline_test_run_id: resource.field(self._.blocks, 'baseline_test_run_id'),
    ...
    k6_project(name, block): {
      local resource = blockType.resource('grafana_k6_project', name),
      _: resource._(block, {
        created: build.template(std.get(block, 'created', null)),
        grafana_folder_uid: build.template(std.get(block, 'grafana_folder_uid', null)),
        id: build.template(std.get(block, 'id', null)),
        is_default: build.template(std.get(block, 'is_default', null)),
        name: build.template(block.name),
        updated: build.template(std.get(block, 'updated', null)),
      ...
      created: resource.field(self._.blocks, 'created'),
      grafana_folder_uid: resource.field(self._.blocks, 'grafana_folder_uid'),
      id: resource.field(self._.blocks, 'id'),
      is_default: resource.field(self._.blocks, 'is_default'),
      name: resource.field(self._.blocks, 'name'),
      updated: resource.field(self._.blocks, 'updated'),
    ...
    k6_project_limits(name, block): {
      ...
      _: resource._(block, {
        duration_max_per_test: build.template(std.get(block, 'duration_max_per_test', null)),
        id: build.template(std.get(block, 'id', null)),
        project_id: build.template(block.project_id),
        vu_browser_max_per_test: build.template(std.get(block, 'vu_browser_max_per_test', null)),
        vu_max_per_test: build.template(std.get(block, 'vu_max_per_test', null)),
        vuh_max_per_month: build.template(std.get(block, 'vuh_max_per_month', null)),
      }),
      duration_max_per_test: resource.field(self._.blocks, 'duration_max_per_test'),
      id: resource.field(self._.blocks, 'id'),
      project_id: resource.field(self._.blocks, 'project_id'),
  ...
  data: {
    ...
    k6_load_tests(name, block): {
      local resource = blockType.resource('grafana_k6_load_tests', name),
      _: resource._(block, {
        id: build.template(std.get(block, 'id', null)),
        load_tests: build.template(std.get(block, 'load_tests', null)),
        name: build.template(std.get(block, 'name', null)),
        project_id: build.template(block.project_id),
      }),
      id: resource.field(self._.blocks, 'id'),
      load_tests: resource.field(self._.blocks, 'load_tests'),
      name: resource.field(self._.blocks, 'name'),
      project_id: resource.field(self._.blocks, 'project_id'),
    },
    k6_project(name, block): {
    ...
    k6_projects(name, block): {
      local resource = blockType.resource('grafana_k6_projects', name),
      _: resource._(block, {
        id: build.template(std.get(block, 'id', null)),
        name: build.template(std.get(block, 'name', null)),
...
local providerWithConfiguration = provider(null, null) + {
  withConfiguration(alias, block): provider(block, {
    ...
    k6_access_token: build.template(std.get(block, 'k6_access_token', null)),
    k6_url: build.template(std.get(block, 'k6_url', null)),
