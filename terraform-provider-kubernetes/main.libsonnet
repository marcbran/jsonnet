...
local provider(rawConfiguration, configuration) = {
  ...
  resource: {
    ...
    secret(name, block): {
      ...
      _: resource._(block, {
        binary_data: build.template(std.get(block, 'binary_data', null)),
        binary_data_wo: build.template(std.get(block, 'binary_data_wo', null)),
        binary_data_wo_revision: build.template(std.get(block, 'binary_data_wo_revision', null)),
        data: build.template(std.get(block, 'data', null)),
        data_wo: build.template(std.get(block, 'data_wo', null)),
        data_wo_revision: build.template(std.get(block, 'data_wo_revision', null)),
        id: build.template(std.get(block, 'id', null)),
        immutable: build.template(std.get(block, 'immutable', null)),
      ...
      binary_data: resource.field(self._.blocks, 'binary_data'),
      binary_data_wo: resource.field(self._.blocks, 'binary_data_wo'),
      binary_data_wo_revision: resource.field(self._.blocks, 'binary_data_wo_revision'),
      data: resource.field(self._.blocks, 'data'),
      data_wo: resource.field(self._.blocks, 'data_wo'),
      data_wo_revision: resource.field(self._.blocks, 'data_wo_revision'),
      id: resource.field(self._.blocks, 'id'),
      immutable: resource.field(self._.blocks, 'immutable'),
    ...
    secret_v1_data(name, block): {
      local resource = blockType.resource('kubernetes_secret_v1_data', name),
      _: resource._(block, {
        data: build.template(block.data),
        field_manager: build.template(std.get(block, 'field_manager', null)),
        force: build.template(std.get(block, 'force', null)),
